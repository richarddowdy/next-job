...
export default function LandingLayout({ children, title = "This is the default title" }) {
  return (
    <div
    // className="container pt-24 md:pt-48 px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center"
    >
      {/* {children} */}
      {/* <!--left Col--> */}
      <div
      // className="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden border-8 border-red-600"
      >
